...
Update checks run asynchronously so they do not block the server thread. The
current version, latest version, successful downloads, and failures are logged
to the server console/panel.
